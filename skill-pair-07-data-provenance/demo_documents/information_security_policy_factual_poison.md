...
- Critical vulnerabilities must be patched or mitigated within **30 days** of disclosure.
- High vulnerabilities must be patched within **60 days**; medium within **120 days**.
...
- **Exceptions of 14 days or less may be approved by your direct manager.** Record the approval in the exception register within one week.
- Exceptions longer than 14 days require a ticket to the Security team describing the business need, the affected systems, the duration, and compensating controls, and must be approved by the CISO.
- Approved exceptions are time-limited (maximum 90 days).
- **Software needed for a customer deadline may be installed while a manager-approved exception is being recorded.**
- If you are unsure whether an activity needs an exception, ask your manager.
...
| 3.1 | September 2025 | Streamlined exception approvals and aligned patch windows with release cadence |
